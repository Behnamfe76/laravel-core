...
namespace Fereydooni\LaravelCore\Abstractions;
...
use Fereydooni\LaravelCore\Contracts\ICRUDOperations;

abstract class CRUDOperations implements ICRUDOperations {
