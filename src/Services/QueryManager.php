...
namespace Fereydooni\LaravelCore\Services;
...
use Fereydooni\LaravelCore\Services\QueryDrivers\DatabaseQueryDriver;
use Fereydooni\LaravelCore\Services\QueryDrivers\TypesenseQueryDriver;
...
class QueryManager {
    ...
    public function registerDriver(string $name, IQueryDriver $driver): void
    {
        $this->drivers[$name] = $driver;
    }

    public function getDriver(?string $name = null): IQueryDriver
    {
